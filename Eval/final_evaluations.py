...
if __name__ == '__main__':
    ...
    dataset_load_path=sys.argv[2]+'/t2m/Comp_v6_KLD01/opt.txt'
    dataset_load_path2=sys.argv[2]
    if model_type==0:
        eval_motion_loaders = {
            ################
            ## HumanML3D Dataset##
            ...
            'Comp_v6_KLD01': lambda: get_motion_loader(
                dataset_load_path,dataset_load_path2,model_type,
        ...
        eval_motion_loaders = {
            ...
            ################
            'Comp_v6_KLD01': lambda: get_motion_loader(
                dataset_opt_path,dataset_load_path2,model_type,
                batch_size, gt_dataset, mm_num_samples, mm_num_repeats, device
            )
        }
