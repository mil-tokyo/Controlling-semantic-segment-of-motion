...
if __name__ == '__main__':
    ...
    data_loader = DataLoader(dataset, batch_size=opt.batch_size, drop_last=True, num_workers=1,
                             shuffle=True, collate_fn=collate_fn,worker_init_fn=seed_worker,generator=g,)
    ...
    with torch.no_grad():
        for i, data in enumerate(data_loader):
            ...
            for t in range(opt.repeat_times):
                ...
                pred_motions, _, att_wgts = trainer.generate(word_emb, pos_ohot, cap_lens, m_lens, m_lens[0], dim_pose)
    ...
    for i, (key, item) in enumerate(result_dict.items()):
        ...
        sub_dict = item['result_01']
        motion2 = sub_dict['motion']
        endframenum2=motion2.shape[0]
        sub_dict = item['result_02']
        motion3 = sub_dict['motion']
        endframenum3=motion3.shape[0]
        ...
        people2=motion2,gen_framelen2=endframenum2,\
        people3=motion3,gen_framelen3=endframenum3,\
